...
r = delete_runs(scope='$SCOPE', run_ids=$PY_IDS, dry_run=True, purge_orphan_logs=bool($ORPHANS))
...
r = delete_runs(scope='$SCOPE', run_ids=$PY_IDS, purge_orphan_logs=bool($ORPHANS))
