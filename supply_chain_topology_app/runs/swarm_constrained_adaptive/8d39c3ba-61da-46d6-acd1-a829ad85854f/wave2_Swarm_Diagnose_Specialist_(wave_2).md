...
- capability: `diagnose`
- wave: 2
- run: `8d39c3ba-61da-46d6-acd1-a829ad85854f`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the shared blackboard the diagnosed typical delay patterns (high-risk pattern combinations) by comparing today’s predicted delays against historical baselines across dimensions. This directly answers the “typical delay patterns” part and provides the evidence needed for optimization recommendations.
