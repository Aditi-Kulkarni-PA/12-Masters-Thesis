...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the shared blackboard, including the key delay-driving patterns, comparisons to historical baselines, and any tool-reported limitations or errors, because the user asked what patterns are driving today's delays.
