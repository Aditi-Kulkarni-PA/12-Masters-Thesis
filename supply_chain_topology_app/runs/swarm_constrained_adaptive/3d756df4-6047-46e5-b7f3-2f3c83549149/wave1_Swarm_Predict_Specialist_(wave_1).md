...
- capability: `predict`
- wave: 1
- run: `3d756df4-6047-46e5-b7f3-2f3c83549149`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders with severity classification to the shared blackboard, including any tool-reported limitations or errors, because this identifies which orders are affected and provides the required input for downstream diagnosis and customer alerts.
