...
- capability: `diagnose`
- wave: 2
- run: `1a849563-b13d-413f-bf67-b3e65bade7c6`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the shared blackboard the diagnosis results: which patterns/dimensions (e.g., region/route/vehicle/delivery-mode/time-related factors as available in the data) are driving today’s delays relative to historical baselines, including the high-risk pattern combinations and how strongly they associate with predicted delay severity. This directly answers what patterns are driving today’s delays.
