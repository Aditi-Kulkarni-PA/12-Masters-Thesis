...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the shared blackboard the simulation results comparing baseline (today without the storm) vs. the “storm hits the East” scenario: how severity distribution changes and which affected orders/patterns shift upward/downward. This directly answers whether delays would get worse under an East storm.
