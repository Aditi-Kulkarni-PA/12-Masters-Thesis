...
- wave: 3
- run: `e1fbe187-ffb3-4ad2-af8c-a46d9cce723a`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Using today’s predicted delayed-orders output plus today’s diagnosis results from the blackboard, produce data-driven optimization recommendations across quick-win, short-term, and long-term horizons. Include actionable steps tied to the diagnosed pattern drivers and any service-level knowledge available to the system. Post the recommendations to the shared blackboard. This matters because it turns the diagnosis into concrete operational actions to reduce future delays.
