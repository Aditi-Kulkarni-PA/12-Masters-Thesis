...
- capability: `diagnose`
- wave: 2
- run: `9626d3bc-25c2-4c06-a6ba-e2675a0bf532`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the diagnosis of today's delay patterns, including key high-risk combinations and root-cause signals, to the shared blackboard so the request's pattern-analysis answer can be produced and recommendations can use the findings.
