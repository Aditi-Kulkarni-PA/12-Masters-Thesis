...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post actionable recommendations across quick-win, short-term, and long-term horizons to the shared blackboard so the request's action plan can be answered.
