...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post one personalised customer email alert per affected order to the shared blackboard so affected customers can be notified.
