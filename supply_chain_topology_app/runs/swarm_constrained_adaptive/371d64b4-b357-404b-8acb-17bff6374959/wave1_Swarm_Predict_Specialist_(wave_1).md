...
- capability: `predict`
- wave: 1
- run: `371d64b4-b357-404b-8acb-17bff6374959`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including each affected order and its predicted delay severity, so the result can be used for the user's delay prediction request.
