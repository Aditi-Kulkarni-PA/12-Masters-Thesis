...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including which orders are predicted to be late and their delay severity, because this identifies the affected customer orders requested.
