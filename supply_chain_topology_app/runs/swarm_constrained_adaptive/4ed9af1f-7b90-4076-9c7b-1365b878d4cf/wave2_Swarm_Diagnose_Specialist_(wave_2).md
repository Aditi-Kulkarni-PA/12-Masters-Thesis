...
- capability: `diagnose`
- wave: 2
- run: `4ed9af1f-7b90-4076-9c7b-1365b878d4cf`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results identifying the main delay reasons, patterns, and high-risk combinations behind the predicted late orders, because this explains why those delays are expected.
