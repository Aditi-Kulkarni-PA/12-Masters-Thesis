...
- wave: 3
- run: `9db4e6f2-c4da-4643-a9fa-c1825b5d74ac`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post optimisation recommendations to the shared blackboard, organised by horizon and tied to the observed delay patterns, so the request's optimisation part can be answered with actionable guidance.
