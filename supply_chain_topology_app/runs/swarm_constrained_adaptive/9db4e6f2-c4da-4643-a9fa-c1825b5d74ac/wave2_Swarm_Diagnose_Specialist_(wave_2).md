...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the shared blackboard, highlighting the main delay patterns, baseline comparisons, and high-risk combinations so the request's pattern-analysis part can be answered.
