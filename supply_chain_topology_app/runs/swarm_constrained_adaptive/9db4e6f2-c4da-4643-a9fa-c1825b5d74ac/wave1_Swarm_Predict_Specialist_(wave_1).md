...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders and severity classifications to the shared blackboard, including any summary needed to support downstream analysis of patterns and optimisation opportunities.
