...
- capability: `diagnose`
- wave: 2
- run: `d4a7ebff-ceb4-45e5-b9b9-f401e3637269`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the shared blackboard the diagnosis results for TODAY: the main delay reasons/patterns inferred by comparing predicted delays to historical baselines, including high-risk pattern combinations across relevant dimensions (e.g., region, carrier/vehicle attributes, delivery mode, time/route buckets—whatever dimensions exist in the data). This matters because recommendations and the storm-in-east simulation should be interpreted in terms of the actual delay drivers/patterns observed historically for similar conditions.
