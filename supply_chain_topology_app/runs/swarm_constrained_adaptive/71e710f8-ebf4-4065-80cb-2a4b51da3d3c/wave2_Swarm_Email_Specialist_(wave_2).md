...
- capability: `email`
- wave: 2
- run: `71e710f8-ebf4-4065-80cb-2a4b51da3d3c`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the generated customer email alerts, one personalised message per affected order, because the request asks to notify impacted customers about predicted delivery delays.
