...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including which orders are predicted to be delayed and their severity, because this identifies the impacted customers for the request and provides the input needed for customer alerts.
