...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the shared blackboard today’s diagnosis results: the key patterns/dimensions driving delays (high-risk combinations) compared against historical baselines, based on the provided predicted delayed orders. This is required to answer what patterns are driving today’s delays and to ground the optimization recommendations.
