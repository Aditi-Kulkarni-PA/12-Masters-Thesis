...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the shared blackboard the diagnosis output: the high-risk pattern combinations and key contributing dimensions explaining today’s predicted delays relative to historical baselines. This supports interpreting why the storm scenario changes impact and what risk drivers are most relevant.
