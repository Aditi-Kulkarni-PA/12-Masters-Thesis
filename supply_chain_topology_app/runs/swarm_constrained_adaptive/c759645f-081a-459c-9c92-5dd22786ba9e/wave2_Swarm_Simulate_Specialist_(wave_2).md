...
- capability: `simulate`
- wave: 2
- run: `c759645f-081a-459c-9c92-5dd22786ba9e`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the scenario's severity-shift results to the shared blackboard, because the request asks for the delivery impact under a storm in the east today.
