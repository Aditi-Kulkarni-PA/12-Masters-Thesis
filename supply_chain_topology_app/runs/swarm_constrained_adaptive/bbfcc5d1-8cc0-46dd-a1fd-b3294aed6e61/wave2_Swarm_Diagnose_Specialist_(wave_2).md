...
- capability: `diagnose`
- wave: 2
- run: `bbfcc5d1-8cc0-46dd-a1fd-b3294aed6e61`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results, including the main delay reasons, high-risk pattern combinations, and any notable comparisons against historical baselines, so recommendations can be grounded in the pattern analysis.
