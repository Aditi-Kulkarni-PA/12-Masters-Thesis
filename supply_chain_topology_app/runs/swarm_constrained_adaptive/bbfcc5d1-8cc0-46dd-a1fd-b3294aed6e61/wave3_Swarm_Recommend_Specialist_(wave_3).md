...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post data-driven optimization recommendations across quick-win, short-term, and long-term horizons, so the delivery manager gets actionable improvements tied to today's delay findings.
