...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the simulation results for the storm in the east region, including how delay severity shifts under that scenario, so the scenario impact is available for the request.
