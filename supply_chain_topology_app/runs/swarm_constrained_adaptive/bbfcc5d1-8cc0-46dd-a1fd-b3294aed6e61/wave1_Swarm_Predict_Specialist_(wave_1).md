...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including order identifiers and predicted severity, so downstream analysis, simulation, recommendations, and customer alerts can use the affected-order set.
