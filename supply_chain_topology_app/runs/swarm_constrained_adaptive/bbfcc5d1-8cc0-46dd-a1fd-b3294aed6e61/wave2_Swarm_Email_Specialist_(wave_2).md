...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post one personalized customer email alert per affected order, with severity-based wording, so customer communications can be generated for all predicted delays.
