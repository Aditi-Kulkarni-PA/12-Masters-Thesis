...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the generated customer email alerts for each predicted delayed order to the shared blackboard so affected customers can be notified with severity-appropriate messages.
