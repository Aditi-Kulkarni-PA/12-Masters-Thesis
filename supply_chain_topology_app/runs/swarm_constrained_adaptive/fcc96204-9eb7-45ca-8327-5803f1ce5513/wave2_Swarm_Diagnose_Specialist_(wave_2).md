...
- capability: `diagnose`
- wave: 2
- run: `fcc96204-9eb7-45ca-8327-5803f1ce5513`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results, including the main delay-driving patterns and high-risk combinations, to the shared blackboard so the request's root-cause pattern analysis is available.
