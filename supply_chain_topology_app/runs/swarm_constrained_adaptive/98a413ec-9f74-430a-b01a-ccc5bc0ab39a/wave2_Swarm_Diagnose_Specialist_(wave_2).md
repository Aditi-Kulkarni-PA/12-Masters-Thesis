...
- capability: `diagnose`
- wave: 2
- run: `98a413ec-9f74-430a-b01a-ccc5bc0ab39a`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the shared blackboard the diagnosis results: which pattern combinations (across the available dimensions) are driving today’s delays, and the key evidence/associations from the historical baseline comparison. This is what recommendations and customer communication should be grounded in.
