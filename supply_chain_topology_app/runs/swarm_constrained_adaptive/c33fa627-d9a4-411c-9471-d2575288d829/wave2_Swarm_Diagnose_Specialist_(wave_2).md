...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the shared blackboard, highlighting the main delay-driving patterns and any high-risk combinations, or the exact tool-level error if diagnosis cannot be completed, because the user asked what patterns are driving today's delays.
