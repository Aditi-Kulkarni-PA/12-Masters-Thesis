...
- capability: `simulate`
- wave: 2
- run: `c33fa627-d9a4-411c-9471-d2575288d829`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the simulation results for the East storm scenario to the shared blackboard, including how delay severity shifts under that scenario or the exact tool-level error if simulation cannot be completed, because the user asked whether delays would worsen if a storm hit the East.
