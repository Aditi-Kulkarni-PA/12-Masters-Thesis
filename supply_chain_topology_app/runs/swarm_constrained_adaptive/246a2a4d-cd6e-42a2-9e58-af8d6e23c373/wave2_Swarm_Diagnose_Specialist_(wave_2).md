...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the shared blackboard, including key delay patterns, root-cause comparisons against historical baselines, and high-risk pattern combinations, because the request asks for diagnosis and recommendations depend on these findings.
