...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post optimization recommendations to the shared blackboard, organized into quick-win, short-term, and long-term actions grounded in today's predicted delays and diagnosis findings, because the request asks for ways to optimize delivery.
