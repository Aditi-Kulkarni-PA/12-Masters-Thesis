...
- capability: `simulate`
- wave: 2
- run: `246a2a4d-cd6e-42a2-9e58-af8d6e23c373`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the simulation results to the shared blackboard, including how delay severity shifts under a storm in the East scenario, because the request explicitly asks for this what-if impact assessment.
