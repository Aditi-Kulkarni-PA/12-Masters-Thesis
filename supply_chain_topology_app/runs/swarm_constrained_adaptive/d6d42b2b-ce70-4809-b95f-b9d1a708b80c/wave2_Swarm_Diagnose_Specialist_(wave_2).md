...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the shared blackboard, highlighting the main delay-driving patterns and high-risk combinations, because the user asked what patterns are driving today's delays.
