...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders with severity classifications to the shared blackboard, including any relevant summary counts, because both the diagnosis and simulation requested depend on the predicted delay output.
