...
- capability: `simulate`
- wave: 2
- run: `d6d42b2b-ce70-4809-b95f-b9d1a708b80c`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the simulation results to the shared blackboard, including how delay severity shifts under a storm in the East, because the user asked whether today's delays would worsen under that scenario.
