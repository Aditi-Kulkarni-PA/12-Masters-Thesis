...
- capability: `predict`
- wave: 1
- run: `68536880-27cf-4f3e-b06b-dca4b6edfb61`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including which orders are predicted to be delayed and their severity classifications, to the shared blackboard so the requested delayed-order answer can be produced.
