...
- capability: `predict`
- wave: 1
- run: `4fce0f7f-6c35-4d78-8bd0-04801a31b683`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Run the delay prediction pipeline on the provided raw input orders file and post the resulting list of today’s orders that are predicted to be delayed, including each affected order’s predicted severity classification. This is the direct output needed to answer which orders are predicted to be delayed.
