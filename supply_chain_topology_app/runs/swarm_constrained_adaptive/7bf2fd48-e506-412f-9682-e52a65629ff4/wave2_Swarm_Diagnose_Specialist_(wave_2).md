...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the shared blackboard, including key reasons, root-cause patterns, and high-risk combinations behind predicted delays, because the request asks for reasons and delay patterns and the recommendation step uses this analysis.
