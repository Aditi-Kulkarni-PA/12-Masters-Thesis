...
- capability: `simulate`
- wave: 2
- run: `7bf2fd48-e506-412f-9682-e52a65629ff4`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the simulation results for the storm-in-the-east-region scenario to the shared blackboard, including how predicted delay severity changes, because the request asks what will happen under that scenario.
