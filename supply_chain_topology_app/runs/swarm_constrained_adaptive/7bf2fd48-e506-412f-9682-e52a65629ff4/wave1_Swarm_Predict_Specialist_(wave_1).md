...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including order identifiers and predicted delay severity, to the shared blackboard because the request asks which orders may be delayed today and downstream diagnosis, simulation, recommendations, and customer emails depend on this output.
