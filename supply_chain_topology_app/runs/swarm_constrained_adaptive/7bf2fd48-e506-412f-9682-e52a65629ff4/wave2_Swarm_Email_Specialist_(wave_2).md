...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the customer email alerts to the shared blackboard, with one personalised severity-based message per predicted delayed order, because the request asks for emails that can be sent to affected customers.
