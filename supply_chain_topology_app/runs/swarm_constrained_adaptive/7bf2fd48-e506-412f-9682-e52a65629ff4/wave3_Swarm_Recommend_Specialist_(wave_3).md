...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's optimization recommendations to the shared blackboard, organized by quick-win, short-term, and long-term actions, because the request asks for recommendations to optimize order delivery.
