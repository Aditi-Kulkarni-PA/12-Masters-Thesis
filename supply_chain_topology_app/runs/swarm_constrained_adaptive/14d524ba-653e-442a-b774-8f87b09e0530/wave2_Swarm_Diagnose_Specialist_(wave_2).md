...
- capability: `diagnose`
- wave: 2
- run: `14d524ba-653e-442a-b774-8f87b09e0530`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Analyse today's predicted delays against historical baselines across every dimension, and identify high-risk pattern combinations. Works from today's predicted delay output; the historical baseline is already available and needs no work to produce. Produce today's diagnosis results. Post the diagnosis results (pattern drivers / high-risk combinations and how they relate to the predicted delays) to the shared blackboard so recommendations and customer communications can reference the key drivers.
