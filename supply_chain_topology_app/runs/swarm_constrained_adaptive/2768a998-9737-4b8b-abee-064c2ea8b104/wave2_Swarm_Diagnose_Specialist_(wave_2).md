...
- capability: `diagnose`
- wave: 2
- run: `2768a998-9737-4b8b-abee-064c2ea8b104`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the shared blackboard the diagnosis results that compare today’s predicted delays against historical baselines, including the high-risk pattern combinations (the dimensions/segments where delays are most elevated). This directly answers the “typical delay patterns” part and provides the evidence base for optimization actions.
