...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders with severity classifications to the shared blackboard, including any tool-reported errors or limitations, because these results are needed to answer which orders may be delayed today and to support downstream diagnosis, simulation, recommendations, and customer alerts.
