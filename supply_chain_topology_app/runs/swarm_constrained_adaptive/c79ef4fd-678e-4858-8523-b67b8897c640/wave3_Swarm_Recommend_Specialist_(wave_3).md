...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post optimization recommendations to the shared blackboard, organized across practical action horizons if available, including any tool-reported errors or limitations, because these recommendations are needed to help optimize order delivery.
