...
- capability: `simulate`
- wave: 2
- run: `c79ef4fd-678e-4858-8523-b67b8897c640`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the simulation results for the storm in the east region to the shared blackboard, including how delay severity changes and any tool-reported errors or limitations, because these results are needed to answer the user's what-if scenario.
