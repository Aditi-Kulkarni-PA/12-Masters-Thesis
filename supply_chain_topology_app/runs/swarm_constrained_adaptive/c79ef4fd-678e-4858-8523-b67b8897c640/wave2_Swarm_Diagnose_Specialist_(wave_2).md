...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the shared blackboard, including identified reasons, delay patterns, high-risk combinations, and any tool-reported errors or limitations, because these findings are needed to explain why delays are expected and to support optimization recommendations.
