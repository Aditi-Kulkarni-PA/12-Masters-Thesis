...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the generated customer email alerts to the shared blackboard, including any tool-reported errors or limitations, because these messages are needed to notify customers whose orders are predicted to be delayed.
