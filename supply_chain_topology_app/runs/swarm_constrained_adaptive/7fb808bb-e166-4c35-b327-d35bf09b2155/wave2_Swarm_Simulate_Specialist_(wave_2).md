...
- capability: `simulate`
- wave: 2
- run: `7fb808bb-e166-4c35-b327-d35bf09b2155`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the shared blackboard the what-if simulation results for the scenario “storm in the east today”, specifically how delay severity shifts for the affected orders (e.g., counts/percentages by severity and which orders move up/down). This directly answers the delivery impact question.
