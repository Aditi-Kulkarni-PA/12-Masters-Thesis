...
- capability: `simulate`
- wave: 2
- run: `d44e92b3-d7be-42f6-9d10-6c95e02e4fe8`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the scenario simulation results showing how delay severity shifts for east-region orders under storm conditions, so the requested delivery impact can be reported.
