...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including the affected customer/order identifiers and severity, because the email step needs the set of impacted customers.
