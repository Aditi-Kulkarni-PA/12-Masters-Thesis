...
- capability: `email`
- wave: 2
- run: `e86af180-02e9-443e-b3a6-a4c0bb650496`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the customer email alerts for each affected order, including the personalized message content and the associated customer/order identifiers, because the user asked to send an email to impacted customers.
