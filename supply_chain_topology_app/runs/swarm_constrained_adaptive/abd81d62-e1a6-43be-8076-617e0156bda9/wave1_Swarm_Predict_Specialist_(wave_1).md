...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including each affected order and its predicted delay severity, so downstream analysis can use the predicted delay output.
