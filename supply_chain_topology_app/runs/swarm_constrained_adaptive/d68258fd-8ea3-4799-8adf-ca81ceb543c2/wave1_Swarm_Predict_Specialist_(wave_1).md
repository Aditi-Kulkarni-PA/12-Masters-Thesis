...
- capability: `predict`
- wave: 1
- run: `d68258fd-8ea3-4799-8adf-ca81ceb543c2`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including which orders are predicted to be delayed and their severity, so the impacted customers can be identified for notification.
