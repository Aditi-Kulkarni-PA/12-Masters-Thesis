...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the generated customer email alerts, one personalised message per affected order based on predicted delay severity, so impacted customers can be notified.
