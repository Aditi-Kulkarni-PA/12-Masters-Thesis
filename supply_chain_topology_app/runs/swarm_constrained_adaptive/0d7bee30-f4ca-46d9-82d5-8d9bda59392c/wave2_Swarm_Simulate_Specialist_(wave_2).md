...
- capability: `simulate`
- wave: 2
- run: `0d7bee30-f4ca-46d9-82d5-8d9bda59392c`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the shared blackboard the simulation outcome for the scenario “storm in the east region”: how delay severity shifts relative to the baseline predicted delays (e.g., which orders become higher severity, which remain similar, and any orders that change status). Include structured scenario metadata so downstream recommendations and customer emails can interpret the impact.
