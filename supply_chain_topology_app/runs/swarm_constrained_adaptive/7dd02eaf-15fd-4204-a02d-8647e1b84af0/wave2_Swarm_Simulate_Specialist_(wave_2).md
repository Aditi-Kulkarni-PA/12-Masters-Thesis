...
- capability: `simulate`
- wave: 2
- run: `7dd02eaf-15fd-4204-a02d-8647e1b84af0`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the what-if simulation results for a storm hitting the East, including how delay severity shifts, because the user asked whether delays would get worse under that scenario.
