...
- capability: `diagnose`
- wave: 2
- run: `2a2cf2b3-348c-410e-bb2d-688f9bd229b8`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results, including the delay-driving patterns and any high-risk combinations, to the shared blackboard because the request asks for the patterns driving today's delays.
