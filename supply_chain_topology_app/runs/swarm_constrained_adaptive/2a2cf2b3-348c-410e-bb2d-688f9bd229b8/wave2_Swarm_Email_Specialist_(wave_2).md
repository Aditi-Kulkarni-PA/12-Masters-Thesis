...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the customer alert messages for each affected order to the shared blackboard because the request asks to notify the affected customers.
