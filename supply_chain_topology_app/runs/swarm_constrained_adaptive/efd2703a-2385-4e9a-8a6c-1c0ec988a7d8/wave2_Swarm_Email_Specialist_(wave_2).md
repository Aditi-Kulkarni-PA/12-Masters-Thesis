...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the customer email alerts to the shared blackboard: one personalised email per affected order, severity-tailored to the predicted severity, and include the recipient address/identifier and the email content. This is required to notify customers impacted by delivery delays.
