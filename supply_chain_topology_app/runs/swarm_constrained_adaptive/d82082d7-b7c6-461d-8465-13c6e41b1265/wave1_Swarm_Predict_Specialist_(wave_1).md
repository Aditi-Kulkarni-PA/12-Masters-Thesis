...
- capability: `predict`
- wave: 1
- run: `d82082d7-b7c6-461d-8465-13c6e41b1265`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including each affected order and its predicted severity, because downstream diagnosis, recommendations, and customer alerts need the predicted-delay output.
