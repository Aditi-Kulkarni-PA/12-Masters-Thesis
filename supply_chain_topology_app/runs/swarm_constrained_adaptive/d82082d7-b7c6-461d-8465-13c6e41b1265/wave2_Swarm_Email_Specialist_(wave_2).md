...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post one personalised customer email alert per affected order, because the request asks to let affected customers know.
