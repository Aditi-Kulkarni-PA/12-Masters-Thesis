...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post actionable optimization recommendations across quick-win, short-term, and long-term horizons, because the request asks what should be done about today's delays.
