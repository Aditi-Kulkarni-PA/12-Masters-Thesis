...
- capability: `simulate`
- wave: 2
- run: `60050a7a-4a5a-42ea-9393-332b6e3c14bc`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the storm-in-the-East simulation output showing how delay severity shifts (e.g., which segments/orders move to higher/lower severity under the storm scenario), because the user asked specifically how the East storm would affect things.
