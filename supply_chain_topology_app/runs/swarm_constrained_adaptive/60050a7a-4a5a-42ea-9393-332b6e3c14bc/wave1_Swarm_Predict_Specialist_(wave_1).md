...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to the blackboard the full set of today’s predicted delayed orders with severity classification (and any identifiers needed to join downstream steps), because diagnosis, storm simulation, and optimization all depend on having today’s predicted delays/severity.
