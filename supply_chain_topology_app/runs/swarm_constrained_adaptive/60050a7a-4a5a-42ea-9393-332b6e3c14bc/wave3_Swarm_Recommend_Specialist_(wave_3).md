...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post optimization recommendations organized by quick-win, short-term, and long-term horizons, explicitly tied to the diagnosed high-risk patterns and (where relevant) adjusted for the storm-in-the-East impact, because this is the actionable output the user requested.
