...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today’s delay-pattern diagnosis results (high-risk pattern combinations vs historical baselines, with the relevant dimensions/segments and severity implications), because optimization and the storm impact interpretation should be grounded in what patterns are actually driving delays today.
