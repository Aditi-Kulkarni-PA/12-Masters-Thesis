...
- capability: `diagnose`
- wave: 1
- run: `c04a77db-ca82-4e96-befb-516067a9bb3e`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the diagnosis of today's predicted delays against historical baselines, including the high-risk pattern combinations and the main reasons associated with delay risk, to the shared blackboard so the user can understand why orders are late.
