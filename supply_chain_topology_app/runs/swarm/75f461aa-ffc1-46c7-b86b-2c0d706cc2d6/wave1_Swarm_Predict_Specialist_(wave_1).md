...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including order identifiers and severity, to the shared blackboard so downstream diagnosis and customer alerts can use the exact affected-order set.
