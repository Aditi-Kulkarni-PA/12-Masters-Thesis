...
- capability: `email`
- wave: 1
- run: `75f461aa-ffc1-46c7-b86b-2c0d706cc2d6`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post severity-based customer email alerts for the affected orders to the shared blackboard, using the predicted delayed-order set once available so the notifications match the actual impacted customers.
