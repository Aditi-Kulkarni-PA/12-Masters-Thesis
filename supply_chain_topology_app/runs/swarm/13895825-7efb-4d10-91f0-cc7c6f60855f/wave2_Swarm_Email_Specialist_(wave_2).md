...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post customer email alerts to the blackboard, one personalised message per affected delayed order. This capability is ready because it depends only on today's predicted delayed orders, which have now been produced.
