...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post simulation results to the blackboard if a concrete scenario is later provided. This capability is ready because it works from today's predicted delayed orders, which have now been produced.
