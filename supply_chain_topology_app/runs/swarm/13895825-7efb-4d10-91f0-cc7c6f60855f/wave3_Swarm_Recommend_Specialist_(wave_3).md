...
- wave: 3
- run: `13895825-7efb-4d10-91f0-cc7c6f60855f`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post recommendation results to the blackboard because diagnosis and prediction are now available. Include prioritized quick wins, short-term actions, and longer-term structural fixes tied directly to today's diagnosed root causes and high-risk combinations.
