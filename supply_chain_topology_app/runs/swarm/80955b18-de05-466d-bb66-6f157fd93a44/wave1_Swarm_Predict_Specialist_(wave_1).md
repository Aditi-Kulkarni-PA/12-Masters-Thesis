...
- capability: `predict`
- wave: 1
- run: `80955b18-de05-466d-bb66-6f157fd93a44`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the list of today’s predicted delayed orders with severity classification (and any order identifiers needed to target affected customers). This is required to determine which orders should be cancelled and which customers should receive refund/cancellation communications.
