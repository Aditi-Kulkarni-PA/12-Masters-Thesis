...
- capability: `simulate`
- wave: 1
- run: `54d8a948-2163-4c78-819d-3159a626001b`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Run a what-if simulation for a storm hitting the East, using today’s predicted delayed orders as the starting point and re-scoring severity against historical patterns. Post the simulated severity shift results (e.g., which segments/orders worsen and by how severity changes) to the shared blackboard. This directly answers the “would that get worse if a storm hit the East” part.
