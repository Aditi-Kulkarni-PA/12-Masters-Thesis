...
- capability: `diagnose`
- wave: 1
- run: `f2414ed4-a694-48bd-8664-7ae1bd673830`
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results explaining the delay reasons and high-risk pattern combinations to the shared blackboard so the user can understand why the orders are late. This matters because the user asked for the reasons for the delay.
