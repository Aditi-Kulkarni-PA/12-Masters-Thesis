...
- capability: `simulate`
- wave: 1
- run: `72d6fc66-f27f-4a89-89bd-e28f20b201b3`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Run a what-if simulation for a storm in the east today and report how delay severity shifts for today’s orders. Post the simulation results (e.g., affected orders and severity changes) to the shared blackboard so downstream steps (if any) can interpret the delivery impact.
