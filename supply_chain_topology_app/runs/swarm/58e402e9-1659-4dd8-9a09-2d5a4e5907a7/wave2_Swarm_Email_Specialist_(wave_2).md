...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the generated customer email alerts to the blackboard, one per affected delayed order with severity-aware wording. This is ready now because predicted delayed orders have been produced, and the user may need customer-facing communication for those late orders.
