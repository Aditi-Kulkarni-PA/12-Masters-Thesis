# Swarm Simulate Specialist (wave 1)

- capability: `simulate`
- wave: 1
- run: `9d092486-05b2-410a-b9fa-ae5b4b66bd89`

## Task (user turn)

Simulate the what-if scenario for today's delivery impact if there is a storm in the east today. Use the raw input orders file path exactly as provided by the user: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv. Scenario wording from the user: "What will be the delivery impact if there is a storm in the east today?" This specialist will need today's predicted delayed orders once they exist, but the scenario context must be preserved verbatim here.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the scenario simulation results to the shared blackboard, showing how delay severity shifts under a storm in the east, because that is the direct answer to the user's what-if question.
