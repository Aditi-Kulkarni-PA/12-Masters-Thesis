...
- wave: 3
- run: `356e5c80-bcf0-46f2-8fda-f1a8819309a2`

## Task (user turn)

Use today's predicted delay output already produced from the input orders file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv. The user asked: Which orders can get delayed today, what are the reasons and delay patterns. Produce data-driven optimization recommendations focused on reducing today's predicted delays, using today's prediction output together with today's diagnosis results already posted to the blackboard.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post recommendation results to the blackboard, using both today's prediction output and today's diagnosis results, because the user asked for reasons and delay patterns and actionable next steps are now ready to be generated.
