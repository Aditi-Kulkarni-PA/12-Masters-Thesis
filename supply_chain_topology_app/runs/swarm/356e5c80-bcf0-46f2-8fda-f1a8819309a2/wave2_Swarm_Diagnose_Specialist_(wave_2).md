...
Analyse today's predicted delays against historical baselines across every dimension, and identify high-risk pattern combinations. Use today's predicted delay output already produced from the input orders file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv. The user asked: Which orders can get delayed today, what are the reasons and delay patterns. Focus on delay patterns and root-cause diagnosis.
