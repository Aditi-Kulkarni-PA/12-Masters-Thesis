...
Use the predicted delayed orders produced by the 'predict' capability for today.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to blackboard under capability 'diagnose' the full diagnosis text (verbatim) including: overall daily vs historical comparison, dimensions where today is worse than historical, historical and daily high-risk patterns, today's long-severity hotspots, and worst dimensions historically and today.
