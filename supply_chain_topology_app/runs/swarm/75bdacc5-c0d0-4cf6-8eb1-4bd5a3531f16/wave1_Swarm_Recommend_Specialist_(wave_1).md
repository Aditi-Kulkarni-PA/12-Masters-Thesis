...
Before you finish, you MUST call write_blackboard to post your result. What to post: After predicted delays and diagnosis results are available on the blackboard, produce data-driven optimization recommendations across quick-win, short-term, and long-term horizons. Use the diagnosis drivers to target actions, and incorporate any available service-level knowledge. Post the recommendations (by horizon, rationale tied to diagnosed drivers, and expected impact) to the shared blackboard.
