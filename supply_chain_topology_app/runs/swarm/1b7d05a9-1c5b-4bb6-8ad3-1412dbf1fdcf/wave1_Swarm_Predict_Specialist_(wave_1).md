...
- capability: `predict`
- wave: 1
- run: `1b7d05a9-1c5b-4bb6-8ad3-1412dbf1fdcf`
...
User request context: What patterns are driving today's delays, what should we do about it, and let affected customers know
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders to the shared blackboard, including order identifiers and severity classifications, because diagnose, recommend, and email all depend on today's predicted delay output.
