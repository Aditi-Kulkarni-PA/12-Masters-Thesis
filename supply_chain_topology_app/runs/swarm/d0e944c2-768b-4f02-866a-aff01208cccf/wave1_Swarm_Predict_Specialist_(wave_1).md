...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Run the delay prediction pipeline over today’s orders from the provided raw input file, and post the resulting dataset of today’s predicted delayed orders with severity classifications to the shared blackboard. This is the required starting artifact for diagnosing typical delay patterns and for generating optimization recommendations.
