...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the predicted delayed orders (with severity) and any summary metrics to the blackboard under capability name 'predict' so downstream diagnosis and recommendations can use it.
