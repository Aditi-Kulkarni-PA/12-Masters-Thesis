...
- capability: `diagnose`
- wave: 2
- run: `d0e944c2-768b-4f02-866a-aff01208cccf`

## Task (user turn)

Analyze today's predicted delays against historical baselines across every dimension, and identify high-risk pattern combinations. Use the predicted delayed orders output from the 'predict' capability for today. Input orders data is in the file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results (root-cause reading of which dimensions, partners and pattern combinations are driving today's delays against historical baselines) to the blackboard under capability name 'diagnose'.
