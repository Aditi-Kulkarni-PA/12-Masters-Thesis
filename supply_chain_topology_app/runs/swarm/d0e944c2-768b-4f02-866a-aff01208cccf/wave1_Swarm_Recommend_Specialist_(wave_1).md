...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Using today’s predicted delayed orders (with severity) together with today’s diagnosis results from the blackboard, generate data-driven optimization recommendations across quick-win, short-term, and long-term horizons. Post the recommendations to the shared blackboard, explicitly tied to the diagnosed high-risk delay patterns.
