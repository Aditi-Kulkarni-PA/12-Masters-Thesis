...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis of predicted delivery delays versus historical baselines, including overall KPIs, dimension-by-dimension comparisons, and high-risk pattern combinations, to the shared blackboard because downstream recommendations depend on this root-cause analysis.
