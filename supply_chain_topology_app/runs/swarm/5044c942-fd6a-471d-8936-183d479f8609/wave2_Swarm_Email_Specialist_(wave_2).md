...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post personalised severity-based customer email alerts for today's affected delayed orders to the shared blackboard because customer notifications depend directly on the predicted delayed orders output.
