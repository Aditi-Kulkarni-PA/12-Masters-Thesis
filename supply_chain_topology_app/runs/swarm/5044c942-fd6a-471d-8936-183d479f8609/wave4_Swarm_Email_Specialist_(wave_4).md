...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post customer-ready email alerts for affected delayed orders, because recommendation output confirms immediate customer notification is needed for high-risk and long-severity delay cases.
