...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including delay likelihood and severity per affected order, to the shared blackboard because the request asks which orders are likely to be delayed and downstream diagnosis and customer notifications depend on this output.
