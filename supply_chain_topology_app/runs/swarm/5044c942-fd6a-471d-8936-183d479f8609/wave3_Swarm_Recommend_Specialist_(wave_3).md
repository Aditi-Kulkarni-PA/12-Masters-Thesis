...
- wave: 3
- run: `5044c942-fd6a-471d-8936-183d479f8609`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post actionable recommendations based on today's predicted delays and this diagnosis of delay patterns versus historical baselines, because management needs prioritized interventions tied to the identified root causes.
