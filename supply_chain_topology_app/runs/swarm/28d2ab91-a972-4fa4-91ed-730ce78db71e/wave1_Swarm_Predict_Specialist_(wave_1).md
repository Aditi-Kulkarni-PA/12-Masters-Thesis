...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Run the delay prediction pipeline on the provided raw daily delivery logistics file and post the resulting dataset of today’s predicted delayed orders with severity classification to the shared blackboard. This is the required starting point for pattern diagnosis, recommendations, and customer email alerts.
