...
- wave: 2
- run: `28d2ab91-a972-4fa4-91ed-730ce78db71e`

## Task (user turn)

Provide data-driven recommendations to optimize order delivery and minimize delays, grounded in both real-time data and SLA commitments. Use today's diagnosis results and predicted delayed orders from blackboard. Input orders data is in the file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post recommended actions (quick-win/short-term/long-term) with dimensions, supporting metrics, and SLA citations to the blackboard under capability name 'recommend'.
