...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: After today’s predicted delayed orders are available on the blackboard, analyze them against historical baselines across all relevant dimensions and identify the high-risk pattern combinations driving today’s delays. Post the diagnosis results to the shared blackboard so recommendations and customer communications can be severity- and cause-aware.
