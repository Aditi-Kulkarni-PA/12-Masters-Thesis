...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Using today’s predicted delayed orders plus the diagnosis results already posted to the blackboard, produce data-driven optimization recommendations across quick-win, short-term, and long-term horizons. Post the recommendations (including which patterns they target and expected impact) to the shared blackboard.
