# Swarm Recommend Specialist (wave 1)
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Using today’s predicted delayed orders plus today’s diagnosis results (and any relevant service-level knowledge available to you), produce data-driven optimization recommendations across quick-win, short-term, and long-term horizons. Post the recommendations to the shared blackboard with actionable steps tied to the diagnosed high-risk pattern combinations and (where relevant) the storm-in-east scenario insights.
