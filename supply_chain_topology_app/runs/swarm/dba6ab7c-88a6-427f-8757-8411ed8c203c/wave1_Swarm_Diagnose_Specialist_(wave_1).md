...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: After you have access to today’s predicted delayed orders/severity output, analyze today’s delay patterns against historical baselines across all relevant dimensions and identify high-risk pattern combinations. Post your diagnosis results to the shared blackboard so downstream simulation (storm in the East) and optimization recommendations can use them.
