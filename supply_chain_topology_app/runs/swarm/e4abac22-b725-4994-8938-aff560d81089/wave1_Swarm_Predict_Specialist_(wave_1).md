...
Predict which of today's orders will be delayed and classify each order's delay severity.
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders and severity classifications to the shared blackboard, including enough detail for downstream diagnosis, simulation, recommendation, and customer email generation. This matters because the rest of the requested analyses depend on the predicted delay output.
