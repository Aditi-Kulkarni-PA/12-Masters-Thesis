...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post customer email alert drafts to the blackboard for today's predicted delayed orders. This capability is ready because it depends only on the predicted delay output, which has now been posted.
