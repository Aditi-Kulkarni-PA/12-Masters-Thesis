...
- capability: `predict`
- wave: 1
- run: `86e89db8-fdf7-4442-a07f-4ecd3ba4563f`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders and severity classifications to the shared blackboard, because diagnosis and simulation both need the predicted-delay output before they can run.
