...
Identify what patterns are driving today's delays using today's predicted delay output already produced from the input orders file. The input orders data is in the file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the blackboard, because recommendations depend on diagnosis and the user explicitly asked to identify what patterns are driving today's delays.
