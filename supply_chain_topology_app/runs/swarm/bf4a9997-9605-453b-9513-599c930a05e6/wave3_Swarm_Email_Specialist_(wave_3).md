...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the generated customer email alerts to the blackboard, because predicted delayed orders already exist and email generation is ready.
