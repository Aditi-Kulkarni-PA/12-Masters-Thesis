...
- capability: `simulate`
- wave: 1
- run: `ff75e3e5-19c3-4913-a036-0d768c3815ca`

## Task (user turn)

What will be the delivery impact if there is a storm in the east today?
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Run a what-if simulation for today assuming a storm in the east, using the provided raw daily delivery logistics file. Post the resulting shift in delay severity/impact (e.g., counts by severity and any key affected segments) to the shared blackboard so downstream steps (if any) can interpret the delivery impact.
