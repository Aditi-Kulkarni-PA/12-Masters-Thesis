...
- capability: `diagnose`
- wave: 1
- run: `f6688559-67b6-4969-8cdc-27f22b08c6bf`

## Task (user turn)

Diagnose today's delay patterns using today's predicted delay output. The input orders data is in the file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv. The user wants diagnosis of today's delay patterns, a what-if check for how a storm in the East would affect things, and delivery optimization recommendations.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the shared blackboard, including the high-risk pattern combinations and any baseline comparisons that matter for downstream simulation and recommendations.
