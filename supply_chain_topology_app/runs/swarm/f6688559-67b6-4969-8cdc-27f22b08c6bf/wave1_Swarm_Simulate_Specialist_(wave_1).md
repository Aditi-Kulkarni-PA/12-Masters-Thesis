...
Check how a storm in the East would affect things. The input orders data is in the file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv. Use the scenario wording exactly: storm in the East. The user wants this as part of today's delay analysis.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the what-if simulation results to the shared blackboard, showing how delay severity shifts under a storm in the East so recommendations can use it.
