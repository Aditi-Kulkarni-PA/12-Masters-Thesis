...
- capability: `diagnose`
- wave: 2
- run: `99837e8c-aacc-430c-83b1-971e3ad17f91`

## Task (user turn)

Analyze today's predicted delays against historical baselines across every dimension, and identify high-risk pattern combinations. Use the predicted delayed orders produced by the predict capability for today's orders from file: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv. Produce today's diagnosis results with the written delay-pattern diagnosis text including all figures and patterns needed for recommendations.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to blackboard under capability 'diagnose' the full diagnosis output text (verbatim, including any numeric comparisons and pattern combos) plus structured fields for dimensions where today is worse than historical and today's long-severity hotspots.
