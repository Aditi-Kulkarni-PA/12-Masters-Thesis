...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to blackboard under capability 'predict' the predicted delayed orders (including order ids, predicted delay/severity, and any key features like mode/region/weather/vehicle/partner if available) plus any overall daily vs historical comparison the model provides.
