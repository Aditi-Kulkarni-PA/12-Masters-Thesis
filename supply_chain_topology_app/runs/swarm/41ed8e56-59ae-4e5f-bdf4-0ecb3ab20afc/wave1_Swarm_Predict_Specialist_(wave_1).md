...
Predict which orders are likely to be delayed today and classify each delayed order's severity. The user also wants the patterns driving those delays and customer notifications for affected customers.
