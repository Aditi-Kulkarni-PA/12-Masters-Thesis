...
- capability: `email`
- wave: 4
- run: `41ed8e56-59ae-4e5f-bdf4-0ecb3ab20afc`

## Task (user turn)

Using today's predicted delayed orders already produced from the input orders file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv and the newly posted recommendation results on the blackboard, generate severity-based customer email alerts, one personalised message per affected order, prioritising the diagnosed hotspots driving today's delays.
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the generated customer email alerts to the blackboard, using today's predicted delayed orders together with the posted recommendations, because downstream consumers may need customer-facing mitigation aligned to the diagnosed patterns and recommended actions.
