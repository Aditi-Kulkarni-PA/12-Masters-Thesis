...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the customer notification emails to the blackboard, one personalised message per affected delayed order, because the user also wants customer notifications for affected customers.
