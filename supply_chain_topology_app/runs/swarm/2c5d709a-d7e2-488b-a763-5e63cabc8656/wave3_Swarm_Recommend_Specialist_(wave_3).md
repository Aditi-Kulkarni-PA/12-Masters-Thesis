...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post recommendation results to the blackboard, using the already-posted predict output and today's diagnosis results to generate actionable optimization recommendations for downstream use.
