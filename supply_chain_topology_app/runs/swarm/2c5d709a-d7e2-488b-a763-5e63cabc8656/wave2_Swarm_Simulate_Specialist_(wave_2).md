...
- capability: `simulate`
- wave: 2
- run: `2c5d709a-d7e2-488b-a763-5e63cabc8656`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post simulation results for the requested what-if scenario(s) to the blackboard, including severity-shift outputs derived from today's predicted delayed orders for downstream use.
