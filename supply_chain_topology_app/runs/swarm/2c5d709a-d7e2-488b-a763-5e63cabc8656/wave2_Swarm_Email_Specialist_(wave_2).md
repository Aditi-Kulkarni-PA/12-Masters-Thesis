...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post generated customer email alerts to the blackboard, one personalised severity-based message per affected delayed order, because today's predicted delayed orders are now available.
