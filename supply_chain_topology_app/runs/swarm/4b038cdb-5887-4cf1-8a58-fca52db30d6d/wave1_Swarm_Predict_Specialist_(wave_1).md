...
- capability: `predict`
- wave: 1
- run: `4b038cdb-5887-4cf1-8a58-fca52db30d6d`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders to the shared blackboard, including each affected order and its predicted delay severity, because this is the direct answer the user asked for and downstream specialists may depend on it.
