...
- capability: `email`
- wave: 1
- run: `857e5905-3984-4677-91a4-f0fd641dfa65`

## Task (user turn)

Identify customers impacted with delivery delays and send an email to them. The input orders data is in the file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the customer email alerts you generate for each affected order to the shared blackboard, using the predicted delayed orders and severity information once available.
