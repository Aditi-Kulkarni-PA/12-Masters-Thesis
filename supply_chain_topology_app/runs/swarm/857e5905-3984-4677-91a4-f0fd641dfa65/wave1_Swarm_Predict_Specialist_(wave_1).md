...
Identify customers impacted with delivery delays from the input orders data in the file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the predicted delayed orders for today to the shared blackboard, including the affected customer/order identifiers and severity so the email specialist can generate alerts.
