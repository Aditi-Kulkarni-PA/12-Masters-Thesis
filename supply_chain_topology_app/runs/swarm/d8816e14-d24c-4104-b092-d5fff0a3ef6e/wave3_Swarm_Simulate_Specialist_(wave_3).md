...
- capability: `simulate`
- wave: 3
- run: `d8816e14-d24c-4104-b092-d5fff0a3ef6e`

## Task (user turn)

What will be the delivery impact if there is a storm in the east today? Use today's predicted delay output already produced from the input orders data at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Run the what-if simulation for the exact scenario wording: 'What will be the delivery impact if there is a storm in the east today?' and post the simulation results to the blackboard, including affected order counts and severity shifts for east-region storm conditions, so downstream stakeholders can quantify scenario impact.
