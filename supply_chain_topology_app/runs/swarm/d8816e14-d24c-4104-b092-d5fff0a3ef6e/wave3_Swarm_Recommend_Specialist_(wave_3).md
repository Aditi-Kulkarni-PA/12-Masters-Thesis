...
Before you finish, you MUST call write_blackboard to post your result. What to post: Use the already-posted prediction output and the diagnosis results once available to produce data-driven optimization recommendations, with enough detail to address east-region storm exposure, express-mode risk, and storm-sensitive vehicle choices.
