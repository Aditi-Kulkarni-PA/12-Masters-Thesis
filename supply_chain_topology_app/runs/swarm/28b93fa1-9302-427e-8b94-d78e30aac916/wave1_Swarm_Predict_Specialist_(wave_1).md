...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders to the shared blackboard, including which orders are predicted to be delayed and their severity classifications, because the request asks which orders can get delayed today and downstream diagnosis, simulation, recommendations, and customer emails depend on this output.
