...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post simulation scenario results to the blackboard, including how severity labels shift under each tested scenario, because scenario planning depends on today's predicted delayed-order set.
