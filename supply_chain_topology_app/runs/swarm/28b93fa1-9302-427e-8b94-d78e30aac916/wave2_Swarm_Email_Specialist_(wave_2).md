...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post customer email outputs to the blackboard, including drafts or templates keyed to predicted delayed orders and severity, because customer communication depends on knowing which orders are predicted to be delayed today.
