...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post actionable recommendations to the blackboard, grounded in today's diagnosis comparison and high-risk patterns, because downstream stakeholders need concrete mitigation steps after root-cause analysis.
