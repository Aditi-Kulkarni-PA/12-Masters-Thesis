...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post prioritized recommendations to the blackboard, tied to the predicted delay patterns and diagnosis findings, because action planning is a downstream dependency after prediction.
