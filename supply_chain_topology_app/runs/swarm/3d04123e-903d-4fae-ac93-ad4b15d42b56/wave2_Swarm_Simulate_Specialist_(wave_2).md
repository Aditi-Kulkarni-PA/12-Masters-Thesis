...
- capability: `simulate`
- wave: 2
- run: `3d04123e-903d-4fae-ac93-ad4b15d42b56`

## Task (user turn)

Simulate the user scenario exactly as worded: what will happen if there is a storm in the east region. Work from today's predicted delayed orders already produced from the input orders file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv. Apply the scenario to the east region with storm conditions and report how delay severity shifts.
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the what-if simulation results for the user's scenario to the blackboard, including the scenario wording, filters/changes applied, and how severity distribution shifts. This is needed because the user explicitly asked for a what-if scenario analysis.
