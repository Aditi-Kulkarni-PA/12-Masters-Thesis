...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post recommendation results to the blackboard, using both the posted prediction output and the posted diagnosis results. Include actionable optimization recommendations tied to the identified delay patterns and root causes, because the diagnosis is now available and recommendations depend on it.
