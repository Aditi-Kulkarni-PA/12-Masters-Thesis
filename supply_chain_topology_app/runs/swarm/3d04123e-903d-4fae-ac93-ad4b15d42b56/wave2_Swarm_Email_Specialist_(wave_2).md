...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the generated customer email alerts to the blackboard, keyed by affected order/delivery identifiers and severity. This is needed because the user asked for customer emails for affected orders.
