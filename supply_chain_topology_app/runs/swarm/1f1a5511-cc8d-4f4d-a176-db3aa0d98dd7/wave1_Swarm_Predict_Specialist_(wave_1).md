...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Run the delay prediction on the supplied input orders file and post today's predicted delayed orders, including affected customer/order details and severity, to the shared blackboard because the email capability depends on this output to generate customer alerts.
