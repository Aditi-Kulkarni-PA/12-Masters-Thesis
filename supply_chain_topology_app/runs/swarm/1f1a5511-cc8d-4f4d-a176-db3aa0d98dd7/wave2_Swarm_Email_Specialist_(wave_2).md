...
- capability: `email`
- wave: 2
- run: `1f1a5511-cc8d-4f4d-a176-db3aa0d98dd7`

## Task (user turn)

Generate severity-based customer email alerts, one personalised message per affected order, using today's predicted delayed orders from the shared blackboard. The input orders data is in the file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv. Identify customers impacted with delivery delays and send an email to them.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the generated customer email alerts to the blackboard because the user explicitly asked to identify impacted customers and send delay emails, and the predict output with delayed orders and severity is now available.
