...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the optimization recommendations to the shared blackboard: quick-win, short-term, and long-term actions grounded in the diagnosed delay patterns. This matters because the user asked how to optimize last-mile delivery.
