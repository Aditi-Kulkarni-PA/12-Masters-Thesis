...
- capability: `email`
- wave: 1
- run: `6c66b075-524b-4ce3-9f8e-6382ef1e3b06`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Generate severity-based customer email alerts (one personalised message per affected order) using today’s predicted delayed orders output from the blackboard. Post the full set of emails (with order-level mapping to recipients) to the shared blackboard so they can be sent/queued by downstream systems.
