...
- capability: `diagnose`
- wave: 1
- run: `e62cf770-ad39-46ea-83cc-ccdb3888d217`

## Task (user turn)

Which orders are likely to be delayed today, what patterns are driving those delays, and can you notify the affected customers?
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Analyze today's predicted delays against historical baselines across every dimension, and identify high-risk pattern combinations. Work from the blackboard’s output of today's predicted delayed orders. Post the diagnosis results (pattern drivers / high-risk combinations and how they relate to delay severity) to the shared blackboard so customer notification can be contextualized and recommendations can be grounded.
