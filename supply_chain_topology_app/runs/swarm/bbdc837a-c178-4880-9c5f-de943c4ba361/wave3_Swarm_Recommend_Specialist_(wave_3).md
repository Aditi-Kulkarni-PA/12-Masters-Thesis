...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post recommendation results to the blackboard because today's diagnosis output is now available and recommendations depend on both prediction and diagnosis outputs.
