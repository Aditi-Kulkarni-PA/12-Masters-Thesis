...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post generated customer email alerts to the blackboard because predicted delayed orders are already available and email generation is ready to run.
