...
- capability: `predict`
- wave: 2
- run: `d413909f-f150-4832-8d64-891f8bc62c95`

## Task (user turn)

Run the two-stage ML pipeline over the raw input orders file supplied in the request, to predict which of today's orders will be delayed and classify each one's severity. Needs nothing but the input orders file.
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to blackboard under capability 'predict' the predicted delayed orders output (including severity) and any summary metrics needed for downstream diagnosis/recommendations.
