...
Use the predicted delayed orders output from capability 'predict' for today.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post to blackboard under capability 'diagnose' the diagnosis results text (verbatim) including any quantified delay-pattern diagnosis and the high-risk pattern combinations it identifies.
