...
Before you finish, you MUST call write_blackboard to post your result. What to post: After you have access to the required upstream outputs (predicted delayed orders and diagnosis results), produce data-driven optimization recommendations across quick-win, short-term, and long-term horizons, and post them to the shared blackboard with the rationale tied to the diagnosed high-risk patterns.
