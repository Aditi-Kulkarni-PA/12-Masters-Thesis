...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post recommendation results to the blackboard, because diagnosis plus prediction are now available and recommendations are ready to run.
