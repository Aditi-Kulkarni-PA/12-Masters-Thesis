...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the blackboard, because downstream recommendations depend on diagnosis plus prediction output.
