...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders and severity classifications to the shared blackboard, because both the delay-pattern diagnosis and the East storm what-if simulation depend on that output.
