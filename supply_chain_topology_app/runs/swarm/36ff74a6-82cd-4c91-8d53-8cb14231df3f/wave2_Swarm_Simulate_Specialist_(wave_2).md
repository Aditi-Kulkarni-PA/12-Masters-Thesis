...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the East storm what-if simulation results to the blackboard, because stakeholders need scenario impact estimates based on today's predicted delayed orders.
