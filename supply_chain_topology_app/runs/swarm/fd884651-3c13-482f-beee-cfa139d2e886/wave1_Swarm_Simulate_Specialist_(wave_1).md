...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the storm-in-the-east-region what-if results, including how delay severity shifts, to the shared blackboard because the user explicitly asked for this scenario analysis.
