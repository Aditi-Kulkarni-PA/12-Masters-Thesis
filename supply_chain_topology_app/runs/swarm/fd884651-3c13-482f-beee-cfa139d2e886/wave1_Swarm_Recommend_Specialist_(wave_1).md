...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post data-driven optimization recommendations across quick-win, short-term, and long-term horizons to the shared blackboard because the user asked for delivery optimization guidance.
