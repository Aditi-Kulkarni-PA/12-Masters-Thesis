...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post one personalized customer email alert per affected order to the shared blackboard because the user asked for customer communications for predicted delays.
