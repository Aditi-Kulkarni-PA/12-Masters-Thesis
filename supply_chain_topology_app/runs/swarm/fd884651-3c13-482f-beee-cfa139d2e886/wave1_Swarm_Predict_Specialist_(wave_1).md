...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders, including order identifiers and severity classification, to the shared blackboard because downstream diagnosis, simulation, recommendations, and customer emails all depend on this output.
