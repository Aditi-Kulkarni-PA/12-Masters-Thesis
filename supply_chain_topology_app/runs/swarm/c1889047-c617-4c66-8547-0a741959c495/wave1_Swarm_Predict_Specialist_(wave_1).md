...
- capability: `predict`
- wave: 1
- run: `c1889047-c617-4c66-8547-0a741959c495`

## Task (user turn)

Can you cancel the delayed orders and issue refunds to the affected customers?
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Run the delay prediction pipeline over the provided raw daily delivery logistics CSV and produce today’s predicted delayed orders with severity classification. Post the resulting list (order identifiers + predicted delay/severity fields) to the shared blackboard so downstream steps can identify which orders to cancel and which customers to notify/refund.
