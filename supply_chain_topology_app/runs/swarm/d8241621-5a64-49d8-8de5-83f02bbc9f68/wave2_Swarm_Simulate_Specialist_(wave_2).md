...
- capability: `simulate`
- wave: 2
- run: `d8241621-5a64-49d8-8de5-83f02bbc9f68`

## Task (user turn)

Simulate what-if changes to weather, vehicle type, region or delivery mode and report how delay severity shifts. Works from today's predicted delayed orders, re-scoring their severity against historical patterns that are already available. Use today's predicted delayed orders already produced from /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv if needed as context.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post any simulation results you run to the blackboard, including the scenario, filters, changes, and resulting severity shifts, because simulations are now ready once predicted delayed orders exist and may support downstream decision-making if requested.
