...
Predict which of today's orders will be delayed and classify each affected order's severity.
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's predicted delayed orders to the shared blackboard, including the affected orders and their predicted severity, because this directly answers the user's request and can support any downstream diagnosis, simulation, recommendation, or email work if later needed.
