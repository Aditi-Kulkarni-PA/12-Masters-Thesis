...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post the generated customer email alerts to the blackboard, one personalised message per affected predicted-delayed order, because email generation is ready once predicted delayed orders exist.
