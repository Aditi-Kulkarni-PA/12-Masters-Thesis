...
Generate severity-based customer email alerts, one personalised message per affected order, using today's predicted delayed orders already available on the blackboard.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post generated customer email alerts to the blackboard because predict output is already available and email depends on it and is now ready to run.
