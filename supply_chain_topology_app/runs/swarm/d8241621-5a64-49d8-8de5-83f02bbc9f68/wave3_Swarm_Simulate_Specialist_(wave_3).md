...
Simulate what-if changes to weather, vehicle type, region or delivery mode and report how delay severity shifts. Works from today's predicted delayed orders already produced from /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post simulation results to the blackboard showing how delay severity shifts under what-if changes, because simulation is ready once predicted delayed orders exist.
