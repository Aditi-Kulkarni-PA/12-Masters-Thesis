# Swarm Simulate Specialist (wave 4)

- capability: `simulate`
- wave: 4
- run: `604ad0ff-7120-41c1-8b89-cf7563715153`

## Task (user turn)

Use today's predicted delay output already produced from the input orders file at path: /Users/aditikulkarni/Documents/Masters/AI-Projects/12-Thesis/0_supply_chain_thesis/prediction_pipeline/data/raw/daily_delivery_logistics_1.csv. The user specifically wants typical delay patterns. Simulate what-if changes to weather, vehicle type, region or delivery mode and report how delay severity shifts, using today's predicted delayed orders that are already available.
...
Before you finish, you MUST call write_blackboard to post your result. What to post: Post what-if simulation results showing how delay severity shifts under changes to weather, vehicle type, region, or delivery mode. This is needed because prediction has already been produced and simulation depends on predict output, which is available.
