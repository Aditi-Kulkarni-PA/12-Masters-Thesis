...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post today's diagnosis results to the blackboard, including overall KPIs, dimension-by-dimension comparison versus historical baselines, and high-risk pattern combinations. This is needed because the request asks why orders are delayed, and downstream recommendations depend on diagnosis output.
