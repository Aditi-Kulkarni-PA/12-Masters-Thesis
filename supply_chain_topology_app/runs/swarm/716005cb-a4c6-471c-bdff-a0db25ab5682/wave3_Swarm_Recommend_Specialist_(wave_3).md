...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post recommendation results to the blackboard, using today's diagnosis and prediction outputs to explain what actions should reduce delays most effectively. This is needed because the request asks why orders are delayed and what to do next, and recommendation depends on diagnosis output plus prediction output, which is already posted.
