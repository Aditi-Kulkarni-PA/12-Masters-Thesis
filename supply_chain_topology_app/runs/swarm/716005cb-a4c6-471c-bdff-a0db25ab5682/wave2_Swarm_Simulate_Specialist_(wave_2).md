...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post simulation results for the requested what-if scenario(s) to the blackboard, including how severity shifts under changed weather, vehicle type, region, or delivery mode conditions. This is needed when scenario analysis is requested and depends on today's predicted delayed orders being available.
