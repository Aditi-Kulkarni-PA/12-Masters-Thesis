...
- capability: `email`
- wave: 4
- run: `716005cb-a4c6-471c-bdff-a0db25ab5682`
...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post customer email alert results to the blackboard, using today's predicted delayed orders to generate one personalised message per affected order. This is needed because recommendation analysis identified immediate customer communication for long-severity and weather-driven delays, and email depends on prediction output which is already posted.
