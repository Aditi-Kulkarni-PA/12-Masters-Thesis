...
## Blackboard
Before you finish, you MUST call write_blackboard to post your result. What to post: Post customer email alert drafts to the blackboard, one personalised message per affected delayed order with severity-aware wording. This is needed because customer communications depend on today's predicted delayed orders.
