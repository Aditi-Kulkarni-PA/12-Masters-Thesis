"""Rebuild a run's full report from the run store alone — no log files, no console scrollback.
    ...
    uv run python supply_chain_topology_app/cli/report_topology_run.py <run_id|latest>
    uv run python supply_chain_topology_app/cli/report_topology_run.py --list
