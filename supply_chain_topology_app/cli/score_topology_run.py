"""Score a completed run's OUTPUT QUALITY and persist it (T42).
    ...
    uv run python supply_chain_topology_app/cli/score_topology_run.py <run_id|latest>
    uv run python supply_chain_topology_app/cli/score_topology_run.py --all-unscored
    uv run python supply_chain_topology_app/cli/score_topology_run.py latest --dry-run
