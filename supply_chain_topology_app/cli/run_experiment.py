...
Run from the repo root, same convention as execute_topology.sh:
    ...
    python supply_chain_topology_app/cli/run_experiment.py -t all -q all -r all -n 1
    python supply_chain_topology_app/cli/run_experiment.py -q 1,2,3 -r 1,2
    python supply_chain_topology_app/cli/run_experiment.py --dry-run
    python supply_chain_topology_app/cli/run_experiment.py --list
