...
invocation the other scripts use:
    ...
    uv run --env-file .env python supply_chain_topology_app/cli/classify_behaviour.py
    uv run --env-file .env python supply_chain_topology_app/cli/classify_behaviour.py --dry-run
    uv run --env-file .env python supply_chain_topology_app/cli/classify_behaviour.py --run-id <id>
