...
**Sample code.** `docs/sample_charts/F17_composite_score.py` — runs unchanged against
...
**Sample code.** `docs/sample_charts/F18_3d_scatter_widget.html` — self-contained,
...
6. **Duplicate spec copy.** This file also exists at
   `papers-articles/Analysis_Report_Design_Spec.md`. Kept in sync manually; the `docs/`
